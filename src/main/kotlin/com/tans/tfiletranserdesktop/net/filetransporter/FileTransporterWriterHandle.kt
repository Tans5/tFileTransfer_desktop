...
sealed class FileTransporterWriterHandle(val action: FileNetAction) : Stateable<FileTransporterWriterHandle.Companion.TransporterWriterState> by Stateable(
    TransporterWriterState.Create
) {
