...
import com.tans.tfiletranserdesktop.net.NET_BUFFER_SIZE
...
import com.tans.tfiletranserdesktop.utils.readDataLimit
import com.tans.tfiletranserdesktop.utils.readString
import com.tans.tfiletranserdesktop.utils.readSuspendSize
...
interface ReaderHandleChains<T> {
    ...
    suspend fun process(data: T, inputStream: InputStream, limit: Long) {
        ...
        if (lastIndex <= 0) {
            ...
            chain(data, inputStream, limit, object :
                ReaderHandleChains<T> { override var chains: List<ReaderHandleChain<T>> = newChains })
        }
    }
